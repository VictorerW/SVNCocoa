#
#  Be sure to run `pod spec lint SVNCocoa.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    dlsa;dl;asld;asld;als;dlasfdhjadhfdjkshfkjsdhf
dfkjsdjfkdsjfksdjkfjsldkfjsdlkjflsdkjfsdlkfjsdlkjfsd
  ...
  s.source       = { :git => "https://github.com/VictorerW/SVNCocoa.git", :tag => "#{s.version}" }
  ...
  # s.vendored_libraries =  "libGeTuiSdk-1.5.3-noidfa.a","libGtExtensionSdk-1.0.0.2"

  s.preserve_paths = "libGeTuiSdk-1.5.3-noidfa.a","libGtExtensionSdk-1.0.0.2"
  s.ios.vendored_library = "libGeTuiSdk-1.5.3-noidfa.a","libGtExtensionSdk-1.0.0.2"  
